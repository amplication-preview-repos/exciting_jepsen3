...
@InputType()
class AppointmentUpdateManyWithoutMasterClassesInput {
...
export { AppointmentUpdateManyWithoutMasterClassesInput as AppointmentUpdateManyWithoutMasterClassesInput };
