...
@InputType()
class AppointmentCreateNestedManyWithoutMasterClassesInput {
...
export { AppointmentCreateNestedManyWithoutMasterClassesInput as AppointmentCreateNestedManyWithoutMasterClassesInput };
