...
export class AppointmentResolverBase {
  ...
  async createAppointment(
    ...
    return await this.service.createAppointment({
      ...
      data: {
        ...
        masterClass: args.data.masterClass
          ? {
              connect: args.data.masterClass,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => MasterClass, {
    nullable: true,
    name: "masterClass",
  })
  @nestAccessControl.UseRoles({
  ...
  async getMasterClass(
    ...
    const result = await this.service.getMasterClass(parent.id);
